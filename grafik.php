<script src="chart.js"></script>
    <div class='box box-default'>
       ...
       // $tahun_sekarang = date('Y');
        ...
        $data = "SELECT MONTH(tgl_faktur) AS bulan, SUM(total2) AS total_per_bulan
        FROM pemesanan
        WHERE status = 'Belum Dibayar' AND YEAR(tgl_faktur) = '$tahun_sekarang'

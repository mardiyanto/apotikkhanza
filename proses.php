...
<html>
  <head>
    ...
    <title><?php echo"$k_k[nama_instansi]";?></title>
	    <!-- Bootstrap 3.3.5 -->
...
.tablediv-row {
    display: tablediv-row;
}

.tablediv-cell {
    display: tablediv-cell;
    border: 1px solid #00a39e; /* Ganti dengan warna atau properti border yang sesuai */
    padding: 5px;
}

.header {
    font-weight: bold;
    background-color: #f9fafa; /* Warna latar belakang untuk header */
}
		</style>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-mini"><?php echo"$k_k[nama_instansi]";?></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><?php echo"$k_k[nama_instansi]";?></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?php echo"$k_k[nama_instansi]";?> </span>
                </a>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p>SELAMAT DATANG</p>
              <a href="index.aspx"><i class="fa fa-circle text-success"></i><?php echo"$k_k[nama_instansi]";?></a>
            </div>
          </div>
          <!-- search form -->
...
<!-- /.content-wrapper -->
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2016 <a href="#">Almsaeed Studio / Web Progremer (<?php echo"$k_k[nama_instansi]";?> )</a>.</strong>  All rights reserved.
      </footer>
